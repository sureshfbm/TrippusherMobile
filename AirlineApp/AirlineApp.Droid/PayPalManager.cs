...
namespace AirlineApp.Droid
{
     ...
     */
        ...
        private PayPalPayment getThingToBuy(string paymentIntent, user item)
        {
            
            return new PayPalPayment(new BigDecimal(item.radio_id), "USD", "Your Subscription",paymentIntent);
        }
		...
		*/
        ...
        public void BuySomething(user item)
        {
            //user obj = new user();
            //obj.radio_id = item.radio_id;
            /* 
         ...
         */
            PayPalPayment thingToBuy = getThingToBuy(PayPalPayment.PaymentIntentSale , item);
